    ...
    public class main : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (context.Request.RequestType == "GET")
            {
                ...
                {
                    StreamReader reader = new StreamReader(AppDomain.CurrentDomain.BaseDirectory + "/html/main.html");
        ...
        private string create_patient_list(List<patient> list)
        {
            ...
            for (i = 0; i < 10 && i < list.Count; i++)
            {
                sb.Append("<tr><td>" + list[i].Id.Value.ToString() +
                    ...
                    "</td><td><span class='revise revisecase' onclick=\"javascript:window.location.href='revisecase.ashx?patient_id=" + list[i].Id.Value.ToString() +
